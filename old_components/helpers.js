let helpers =  {
  ...
  getFunName : function() {
    ...
    var nouns = ['women', 'men', 'kerbals', 'kerbals', 'kerbals', 'kerbals', 'kerbals', 'kerbals', 'kerbals', 'kerbals', 'kerbals', 'kerbals', 'kerbals', 'kerbals', 'kerbals', 'kerbals', 'kerbals', 'kerbals', 'kerbals', 'kerbals', 'kerbals', 'children', 'teeth', 'feet', 'people', 'leaves', 'mice', 'geese', 'halves', 'knives', 'wives', 'lives', 'elves', 'loaves', 'potatoes', 'tomatoes', 'cacti', 'foci', 'fungi', 'nuclei', 'syllabuses', 'analyses', 'diagnoses', 'oases', 'theses', 'crises', 'phenomena', 'criteria', 'data'];
